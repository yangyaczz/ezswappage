...
const NFTsSelectedRange = ({ radioRef, styleClass }) => {
  ...
  useEffect(() => {
    console.log('aaaa', selectedNFTs.length,selected1155NFTAmount)
    ...
    <div className={`flex gap-2 items-center ${styleClass} `}>
      ...
      />
        <input
            ...
            value = {numVal}
            onChange={handleRangeChange}
            className="border-l-solid text-base text-right border-l-2 w-11 sm:text-base lg:text-base bg-black"
        />
