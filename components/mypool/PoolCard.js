        ...
        <div className="flex flex-col p-6 mb-4 rounded-lg shadow-md border border-solid border-white">
            ...
            <div className="min-[800px]:flex min-[800px]:justify-between py-4 rounded-lg bg-base-200 ">
                <div className='flex min-[800px]:flex-col max-[799px]:items-center'>
                    ...
                    {item.type === "1" && <span className="lg:mt-1 text-gray-500 ">{item.currentBuyPrice === undefined? `0` :` ${item.currentBuyPrice}`}&nbsp;{item.tokenName === 'ETH' && addressSymbol[formikData.values.golbalParams.hex]["0x0000000000000000000000000000000000000000"] === 'EOS' ? 'EOS' : item.tokenName}</span>}
                    { item.type === "0" && <span className="lg:mt-1 text-gray-500 ">{item.currentSellPrice === undefined? `0` :` ${item.currentSellPrice}`}&nbsp;{item.tokenName === 'ETH' && addressSymbol[formikData.values.golbalParams.hex]["0x0000000000000000000000000000000000000000"] === 'EOS' ? 'EOS' : item.tokenName}</span>}
                    { item.type === "2" && <span className="lg:mt-1 text-gray-500 ">buy&sell:&nbsp; {item.currentSellPrice === undefined? `0` :`${item.currentBuyPrice} & ${item.currentSellPrice}`}&nbsp;{item.tokenName === 'ETH' && addressSymbol[formikData.values.golbalParams.hex]["0x0000000000000000000000000000000000000000"] === 'EOS' ? 'EOS' : item.tokenName}</span>}
                </div>
