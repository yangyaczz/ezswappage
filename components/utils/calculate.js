...
export function BuyPoolLiner(spotPrice, delta, tfee, pfee, n = 1, action = 'read') {
    ...
    const last = n - 1
    const lastUserSellPrice = sumDesLiner(spotPrice, last, delta) * (1 - tfee - pfee)
...
export function BuyPoolExp(spotPrice, delta, tfee, pfee, n = 1, action = 'read') {
...
export function TradePoolExp(spotPrice, delta, tfee, pfee, n = 1, action = 'read') {
