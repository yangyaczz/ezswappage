        ...
        <div className='flex items-center justify-center space-x-4 justify-between'>
            ...
            <div className='form-control'>
                <div className="input-group">
                    <button onClick={handleDecrement} className="btn-square border rounded-r-none border-1 max-[800px]:w-9  border-white hover:border-white bg-black rounded-l-xl">-</button>
                    ...
                    <button onClick={handleIncrement} className="btn-square border rounded-l-none border-1 max-[800px]:w-9  border-white hover:border-white bg-black rounded-r-xl">+</button>
                </div>
            </div>
