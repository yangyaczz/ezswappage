                ...
                <div className="min-[1500px]:ml-20  ml-14 min-[1700px]:ml-32  max-[800px]:ml-0">
                    ...
                    <div className=" pt-16 max-[800px]:pl-10">
                        ...
                        <div className="flex max-[800px]:flex-col max-[800px]:mr-10">
                            {/*第一个item*/}
                            <div className="bg-black border border-[#737373] rounded-md pt-10 pb-7 max-[800px]:pb-4 text-white min-[799px]:mr-5 max-[1500px]:h-[240px] min-[800px]:w-[400px]  min-[1500px]:w-[480px]">
                                {/*最外面上下布局*/}
                                <div className="flex items-center pl-8 pr-5 max-[800px]:pr-1 max-[800px]:pl-5">
                                    ...
                                    <div className="ml-8 max-[800px]:ml-5">
                                        <div className="text-4xl max-[1500px]:text-3xl font-bold max-[800px]:text-3xl">EZswap Protocol</div>
                            ...
                            <a href="https://twitter.com/echomkts">
                                <div className="flex flex-col items-center bg-black border border-[#737373] rounded-md pt-10 pb-7 max-[800px]:mt-7  text-white min-[799px]:mr-5 max-[1500px]:h-[240px] min-[800px]:w-[400px]  min-[1500px]:w-[480px]">
                                    {/*最外面上下布局*/}
                                    <div>
                                        <div className="flex items-center max-[800px]:pr-1 max-[800px]:pl-5">
                                            ...
                                            <div className="ml-8 max-[800px]:ml-5">
                                                <div className="text-4xl max-[1500px]:text-3xl font-bold max-[800px]:text-3xl">ECHO 404</div>
                            ...
                            <a href="https://twitter.com/mars404_manta">
                                <div className="flex flex-col items-center bg-black border border-[#737373] rounded-md pt-10 pb-7 text-white max-[800px]:mt-7 min-[799px]:mr-5  max-[1500px]:h-[240px] min-[800px]:w-[400px] min-[1500px]:w-[480px]">
                                    {/*最外面上下布局*/}
                                    <div>
                                        <div className="flex items-center max-[800px]:pr-1  max-[800px]:pl-5">
                                            {/*里面左右布局*/}
                                            ...
                                            <div className="ml-8 max-[800px]:ml-5">
                                                <div className="text-4xl max-[1500px]:text-3xl font-bold max-[800px]:text-3xl">Mars 404</div>
                                        ...
                                        <div className="flex items-center mt-7 max-[800px]:ml-5">
                                            ...
                                            <div className="ml-3">
                                                <div className="text-[#3ACD37] max-[1500px]:text-3xl text-5xl font-bold max-[800px]:text-3xl"><span className="mr-1">+</span>4001%</div>
                                                <div className="text-[7px] text-center text-[#9B9B9B] mt-2">ATH since Launch</div>
                                            </div>
                                        </div>
                                    </div>
