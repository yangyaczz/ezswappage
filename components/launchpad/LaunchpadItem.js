...
const LaunchpadItem = ({launchpadItem,step}) => {
    return (
        <div>
            <Link href={`/launchpaddetail?id=${launchpadItem.id}`}>
                <div className="mt-10 card w-[25rem] max-[800px]:w-[18rem] bg-base-100 shadow-xl border overflow-hidden">
                        ...
                        <div className="flex-1 text-xs">
                            ...
                            <div className="flex justify-between border-b border-[#999999]  mt-1">
                                ...
                                <span className="flex items-center">
                                    ...
                                    <span>{launchpadItem.publicPrice === 0 ?"Free Mint": launchpadItem.publicPrice/1e18}</span>
                                </span>
                            </div>
                            <div className="flex justify-between border-b border-[#999999]  mt-1">
